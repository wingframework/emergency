...
export class StaffManageComponent {
      ...
      buttons: [
        {
          ...
          text: '禁用',
          click: item =>
            this.staffControllerService
              .enableStaffByIdUsingGET(item.id, false)
              .toPromise()
              .then(r => this.getData())
        },
        {
          ...
          click: item =>
            this.staffControllerService
              .enableStaffByIdUsingGET(item.id, true)
              .toPromise()
              .then(r => this.getData())
        },

        {
          ...
          click: item =>
            this.staffControllerService
              .deleteStaffByIdUsingDELETE(item.id)
              .toPromise()
              .then(r => this.getData())
        }
      ]
  ...
  async ngOnInit() {
    let data: any[] = []; //await this.staffControllerService.queryNotStaffUserUsingGET().toPromise();
